    ...
    renderThemeGrid() {
        ...
        this.customThemes.forEach((themeObj, idx) => {
            ...
            preview.style.background = `
                radial-gradient(closest-side at 50% 50%, ${themeObj.colors[0]}, transparent 100%),
                radial-gradient(closest-side at 60% 40%, ${themeObj.colors[1]}, transparent 100%),
                radial-gradient(closest-side at 40% 60%, ${themeObj.colors[2]}, transparent 100%),
                radial-gradient(closest-side at 30% 70%, ${themeObj.colors[3]}, transparent 100%),
                radial-gradient(closest-side at 70% 30%, ${themeObj.colors[4]}, transparent 100%)
            `;
