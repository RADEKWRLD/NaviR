...
export class ThemeManager {
    ...
    updateCustomPreview() {
        ...
        preview.style.background = `
            radial-gradient(closest-side, ${colors[0]}, transparent),
            radial-gradient(closest-side, ${colors[1]}, transparent),
            radial-gradient(closest-side, ${colors[2]}, transparent),
            radial-gradient(closest-side, ${colors[3]}, transparent),
            radial-gradient(closest-side, ${colors[4]}, transparent)
        `;
        preview.style.backgroundSize = '130% 130%, 80% 80%, 90% 90%, 110% 110%, 90% 90%';
        preview.style.backgroundPosition = '-80vmax -80vmax, 60vmax -30vmax, 10vmax 10vmax, -30vmax -10vmax, 50vmax 50vmax';
        preview.style.animation = '10s movement linear infinite';
    }
