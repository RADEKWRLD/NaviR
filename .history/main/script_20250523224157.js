...
const engineIcon = engineBtn.querySelector('.engine-icon');
const engineText = engineBtn.querySelector('.engine-text');

// 默认显示 Google
engineIcon.innerHTML = engineSVGs['Google'];
...
document.querySelectorAll('#engine-menu li').forEach(li => {
    li.addEventListener('click', function() {
        ...
        engineIcon.innerHTML = engineSVGs[name] || '';
