...
const defaultShortcuts = [
    ...
    },
    {
        ...
        icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#4F8CFF"/><path d="M7 12h10M12 7v10" stroke="#fff" stroke-width="2" stroke-linecap="round"/></svg>'
    },
    {
        name: 'Kimi',
        url: 'https://kimi.moonshot.cn',
        icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="5" fill="#7B61FF"/><text x="12" y="17" text-anchor="middle" font-size="10" fill="#fff" font-family="Arial">K</text></svg>'
    },
    {
        name: '网易云音乐',
        url: 'https://music.163.com',
        icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#E93B3D"/><path d="M15.5 13.5a3.5 3.5 0 1 1-3.5-3.5" stroke="#fff" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="16" r="1" fill="#fff"/></svg>'
    },
    {
        name: 'Gmail',
